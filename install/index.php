        ...
        <fieldset>
            ...
            <ul>
                <li>
                    ...
                    <input type="text" name="HostName" id="HostName" required="true" value="127.0.0.1" placeholder="<?php echo _('Enter database host name'); ?>" />
                ...
                <li>
                    ...
                    <?php
                        ...
                        if(!empty($CountrySQLs)){
                            ...
                            echo '<option value="default.sql">' . _('Default CoA') . '</option>';
                        }
                    ?>
                    </select>
